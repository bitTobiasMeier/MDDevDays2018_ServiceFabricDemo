...
namespace Platform.Controllers
{
    ...
    public class SessionController : Controller
    {
        ...
        private static IStatefulSessionService GetProxy()
        {
            var proxy = ServiceProxy.Create<IStatefulSessionService>(
                new Uri("fabric:/MDDevDays2018/StatefulSessionService"),
